...
<p style="margin:0 0 8px;"><strong>Amount:</strong> ${escapeHtml(amount)} ${escapeHtml(asset)}</p>
<p style="margin:0 0 8px;word-break:break-all;"><strong>Destination:</strong> ${escapeHtml(destination)}</p>
<p style="margin:0;word-break:break-all;"><strong>Transaction:</strong> ${escapeHtml(txHash)}</p>
</div>`,
    "check",
  );
}
